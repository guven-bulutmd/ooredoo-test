...
var stepTwo = function (props) {
    ...
    var _b = (0, react_1.useState)(""), otpCode = _b[0], setOTPCode = _b[1];
    var _c = (0, react_1.useState)(false), isPinReady = _c[0], setIsPinReady = _c[1];
    var _d = (0, react_1.useState)(false), isLoading = _d[0], setIsLoading = _d[1];
    var _e = (0, react_1.useState)(false), isError = _e[0], setIsError = _e[1];
    ...
    (0, react_1.useEffect)(function () {
        var handleSubmit = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!((otpCode === null || otpCode === void 0 ? void 0 : otpCode.length) === 4)) return [3 /*break*/, 5];
    ...
    return (react_1.default.createElement(react_native_1.View, { style: { padding: 24, display: "flex", flexDirection: "column" } },
        ...
        react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: function () {
                var url = "/registerStepThree?serviceNumber=".concat(serviceNumberFinal, "&Qid=").concat(QidFinal);
                if (react_native_1.Platform.OS !== "web") {
